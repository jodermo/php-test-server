...
class ChatService
{
    ...
    {
        $parems = ("page=chat&chat_title=" . rawurlencode($this->chatTitle) . "&chat_room=" . rawurlencode($this->chatRoom) . "&key=" . rawurlencode($this->cryptoKey->saveToAsciiSafeString()));
