<div class="menu">
    ...
    <?php echo (($app->pageName != 'mollie') ?  '<div class="menu-item"><a href="/?page=mollie">Connect To Mollie</a></div>' : null); ?>
    <?php echo (($app->pageName != 'mollie') ?  '<div class="menu-item"><a href="/?page=mollie&pay=1">Pay To Mollie</a></div>' : null); ?>
